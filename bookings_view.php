...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->ColCaption = array("Id number", "Fullname", "Phone", "truck", "slot", "Amount", "Date", "Departure Time", "Luggage", "Date booked");
	$x->ColFieldName = array('id_number', 'fullname', 'phone', 'truck', 'slot', 'amount', 'date', 'time', 'luggage', 'date_booked');
