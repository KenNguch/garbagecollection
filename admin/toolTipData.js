...
slots_view0Tip=["",spacer+"This option prohibits all members of the group from viewing any record in the 'slots' table."];
slots_view1Tip=["",spacer+"This option allows each member of the group to view only his own records in the 'slots' table."];
slots_view2Tip=["",spacer+"This option allows each member of the group to view any record owned by any member of the group in the 'slots' table."];
slots_view3Tip=["",spacer+"This option allows each member of the group to view all records in the 'slots' table."];

slots_edit0Tip=["",spacer+"This option prohibits all members of the group from modifying any record in the 'slots' table."];
slots_edit1Tip=["",spacer+"This option allows each member of the group to edit only his own records in the 'slots' table."];
slots_edit2Tip=["",spacer+"This option allows each member of the group to edit any record owned by any member of the group in the 'slots' table."];
slots_edit3Tip=["",spacer+"This option allows each member of the group to edit any records in the 'slots' table, regardless of their owner."];

slots_delete0Tip=["",spacer+"This option prohibits all members of the group from deleting any record in the 'slots' table."];
slots_delete1Tip=["",spacer+"This option allows each member of the group to delete only his own records in the 'slots' table."];
slots_delete2Tip=["",spacer+"This option allows each member of the group to delete any record owned by any member of the group in the 'slots' table."];
slots_delete3Tip=["",spacer+"This option allows each member of the group to delete any records in the 'slots' table."];
