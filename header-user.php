...
<head>
    ...
    <title>GARBAGE BOOKING SYSTEM</title>
	<!-- Bootstrap Styles-->
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Garbage Kollectors</a>
            </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
			 <div class="row">
                 ...
                 <!-- /. ROW  -->
				 <footer><strong><p>truck Booking System(Trial Version).All rights reserved. Project Made by: <a href="http://www.ronaldngoda.rf.gd">Ronald Ngoda +254708344101</a></p></strong></footer>
				</div>
             <!-- /. PAGE INNER  -->
            </div>
         <!-- /. PAGE WRAPPER  -->
