...
function availability_insert(){
	...
	sql('insert into `availability` set       `truck`=' . (($data['truck'] !== '' && $data['truck'] !== NULL) ? "'{$data['truck']}'" : 'NULL') . ', `route`=' . (($data['route'] !== '' && $data['route'] !== NULL) ? "'{$data['route']}'" : 'NULL') . ', `amount`=' . (($data['amount'] !== '' && $data['amount'] !== NULL) ? "'{$data['amount']}'" : 'NULL') . ', `date`=' . (($data['date'] !== '' && $data['date'] !== NULL) ? "'{$data['date']}'" : 'NULL') . ', `time`=' . (($data['time'] !== '' && $data['time'] !== NULL) ? "'{$data['time']}'" : 'NULL') . ', `status`=' . (($data['status'] !== '' && $data['status'] !== NULL) ? "'{$data['status']}'" : 'NULL'), $o);
	if($o['error']!=''){
		echo $o['error'];
...
function availability_delete($selected_id, $AllowDeleteOfParents=false, $skipChecks=false){
	...
	$id = db_fetch_row($res);
	$rires = sql("select count(1) from `bookings` where `truck`='".addslashes($id[0])."'", $eo);
...
function availability_update($selected_id){
	...
	$o=array('silentErrors' => true);
	sql('update `availability` set       `truck`=' . (($data['truck'] !== '' && $data['truck'] !== NULL) ? "'{$data['truck']}'" : 'NULL') . ', `route`=' . (($data['route'] !== '' && $data['route'] !== NULL) ? "'{$data['route']}'" : 'NULL') . ', `amount`=' . (($data['amount'] !== '' && $data['amount'] !== NULL) ? "'{$data['amount']}'" : 'NULL') . ', `date`=' . (($data['date'] !== '' && $data['date'] !== NULL) ? "'{$data['date']}'" : 'NULL') . ', `time`=' . (($data['time'] !== '' && $data['time'] !== NULL) ? "'{$data['time']}'" : 'NULL') . ', `status`=' . (($data['status'] !== '' && $data['status'] !== NULL) ? "'{$data['status']}'" : 'NULL') . " where `id`='".makeSafe($selected_id)."'", $o);
	if($o['error']!=''){
		echo $o['error'];
...
function availability_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0, $TemplateDV = '', $TemplateDVP = ''){
		...
		<?php if(($AllowUpdate || $AllowInsert) && !$dvprint){ ?>
			...
			$j("#truck-container__RAND__").select2({
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ /* */ return { s: term, p: page, t: 'availability', f: 'truck' }; },
	...
	$lookup_fields = array(  'truck' => array('trucks', 'truck'), 'route' => array('routes', 'Route'));
