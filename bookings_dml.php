...
function bookings_insert(){
	...
	$data['truck'] = makeSafe($_REQUEST['truck']);
		if($data['truck'] == empty_lookup_value){ $data['truck'] = ''; }
	$data['slot'] = makeSafe($_REQUEST['slot']);
		if($data['slot'] == empty_lookup_value){ $data['slot'] = ''; }
	$data['amount'] = makeSafe($_REQUEST['truck']);
		if($data['amount'] == empty_lookup_value){ $data['amount'] = ''; }
	$data['date'] = makeSafe($_REQUEST['truck']);
		if($data['date'] == empty_lookup_value){ $data['date'] = ''; }
	$data['time'] = makeSafe($_REQUEST['truck']);
	...
	sql('insert into `bookings` set       `id_number`=' . (($data['id_number'] !== '' && $data['id_number'] !== NULL) ? "'{$data['id_number']}'" : 'NULL') . ', `fullname`=' . (($data['fullname'] !== '' && $data['fullname'] !== NULL) ? "'{$data['fullname']}'" : 'NULL') . ', `phone`=' . (($data['phone'] !== '' && $data['phone'] !== NULL) ? "'{$data['phone']}'" : 'NULL') . ', `truck`=' . (($data['truck'] !== '' && $data['truck'] !== NULL) ? "'{$data['truck']}'" : 'NULL') . ', `slot`=' . (($data['slot'] !== '' && $data['slot'] !== NULL) ? "'{$data['slot']}'" : 'NULL') . ', `amount`=' . (($data['amount'] !== '' && $data['amount'] !== NULL) ? "'{$data['amount']}'" : 'NULL') . ', `date`=' . (($data['date'] !== '' && $data['date'] !== NULL) ? "'{$data['date']}'" : 'NULL') . ', `time`=' . (($data['time'] !== '' && $data['time'] !== NULL) ? "'{$data['time']}'" : 'NULL') . ', `luggage`=' . (($data['luggage'] !== '' && $data['luggage'] !== NULL) ? "'{$data['luggage']}'" : 'NULL') . ', `date_booked`=' . "'{$data['date_booked']}'", $o);
	if($o['error']!=''){
		echo $o['error'];
...
function bookings_update($selected_id){
	...
	$o=array('silentErrors' => true);
	sql('update `bookings` set       `id_number`=' . (($data['id_number'] !== '' && $data['id_number'] !== NULL) ? "'{$data['id_number']}'" : 'NULL') . ', `fullname`=' . (($data['fullname'] !== '' && $data['fullname'] !== NULL) ? "'{$data['fullname']}'" : 'NULL') . ', `phone`=' . (($data['phone'] !== '' && $data['phone'] !== NULL) ? "'{$data['phone']}'" : 'NULL') . ', `truck`=' . (($data['truck'] !== '' && $data['truck'] !== NULL) ? "'{$data['truck']}'" : 'NULL') . ', `slot`=' . (($data['slot'] !== '' && $data['slot'] !== NULL) ? "'{$data['slot']}'" : 'NULL') . ', `amount`=' . (($data['amount'] !== '' && $data['amount'] !== NULL) ? "'{$data['amount']}'" : 'NULL') . ', `date`=' . (($data['date'] !== '' && $data['date'] !== NULL) ? "'{$data['date']}'" : 'NULL') . ', `time`=' . (($data['time'] !== '' && $data['time'] !== NULL) ? "'{$data['time']}'" : 'NULL') . ', `luggage`=' . (($data['luggage'] !== '' && $data['luggage'] !== NULL) ? "'{$data['luggage']}'" : 'NULL') . ', `date_booked`=`date_booked`' . " where `id`='".makeSafe($selected_id)."'", $o);
	if($o['error']!=''){
		echo $o['error'];
...
function bookings_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0, $TemplateDV = '', $TemplateDVP = ''){
	...
	$filterer_truck = thisOr(undo_magic_quotes($_REQUEST['filterer_truck']), '');
	$filterer_slot = thisOr(undo_magic_quotes($_REQUEST['filterer_slot']), '');
	...
	// combobox: truck
	$combo_truck = new DataCombo;
	// combobox: slot
	$combo_slot = new DataCombo;
	...
	if($selected_id){
		...
		$combo_truck->SelectedData = $row['truck'];
		$combo_slot->SelectedData = $row['slot'];
		$combo_date_booked->DefaultDate = $row['date_booked'];
	}else{
		$combo_id_number->SelectedData = $filterer_id_number;
		$combo_truck->SelectedData = $filterer_truck;
		$combo_slot->SelectedData = $filterer_slot;
	}
	...
	$combo_truck->HTML = '<span id="truck-container' . $rnd1 . '"></span><input type="hidden" name="truck" id="truck' . $rnd1 . '" value="' . html_attr($combo_truck->SelectedData) . '">';
	$combo_truck->MatchText = '<span id="truck-container-readonly' . $rnd1 . '"></span><input type="hidden" name="truck" id="truck' . $rnd1 . '" value="' . html_attr($combo_truck->SelectedData) . '">';
	$combo_slot->HTML = '<span id="slot-container' . $rnd1 . '"></span><input type="hidden" name="slot" id="slot' . $rnd1 . '" value="' . html_attr($combo_slot->SelectedData) . '">';
	$combo_slot->MatchText = '<span id="slot-container-readonly' . $rnd1 . '"></span><input type="hidden" name="slot" id="slot' . $rnd1 . '" value="' . html_attr($combo_slot->SelectedData) . '">';
	...
	<script>
		...
		AppGini.current_truck__RAND__ = { text: "", value: "<?php echo addslashes($selected_id ? $urow['truck'] : $filterer_truck); ?>"};
		AppGini.current_slot__RAND__ = { text: "", value: "<?php echo addslashes($selected_id ? $urow['slot'] : $filterer_slot); ?>"};

		jQuery(function() {
			setTimeout(function(){
				if(typeof(id_number_reload__RAND__) == 'function') id_number_reload__RAND__();
				if(typeof(truck_reload__RAND__) == 'function') truck_reload__RAND__();
				if(typeof(slot_reload__RAND__) == 'function') slot_reload__RAND__();
		...
		function truck_reload__RAND__(){
		<?php if(($AllowUpdate || $AllowInsert) && !$dvprint){ ?>

			$j("#truck-container__RAND__").select2({
				/* initial default value */
				initSelection: function(e, c){
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { id: AppGini.current_truck__RAND__.value, t: 'bookings', f: 'truck' },
						success: function(resp){
							c({
								id: resp.results[0].id,
								text: resp.results[0].text
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ /* */ return { s: term, p: page, t: 'bookings', f: 'truck' }; },
					results: function(resp, page){ /* */ return resp; }
				},
				escapeMarkup: function(str){ /* */ return str; }
			}).on('change', function(e){
			...
			if(!$j("#truck-container__RAND__").length){
				$j.ajax({
					url: 'ajax_combo.php',
					dataType: 'json',
					data: { id: AppGini.current_truck__RAND__.value, t: 'bookings', f: 'truck' },
		...
		function slot_reload__RAND__(){
		<?php if(($AllowUpdate || $AllowInsert) && !$dvprint){ ?>

			$j("#slot-container__RAND__").select2({
				/* initial default value */
				initSelection: function(e, c){
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { id: AppGini.current_slot__RAND__.value, t: 'bookings', f: 'slot' },
						success: function(resp){
							c({
								id: resp.results[0].id,
								text: resp.results[0].text
							});
							$j('[name="slot"]').val(resp.results[0].id);
							$j('[id=slot-container-readonly__RAND__]').html('<span id="slot-match-text">' + resp.results[0].text + '</span>');
							if(resp.results[0].id == '<?php echo empty_lookup_value; ?>'){ $j('.btn[id=slots_view_parent]').hide(); }else{ $j('.btn[id=slots_view_parent]').show(); }


							if(typeof(slot_update_autofills__RAND__) == 'function') slot_update_autofills__RAND__();
						}
					});
				},
				width: '100%',
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ /* */ return { s: term, p: page, t: 'bookings', f: 'slot' }; },
					results: function(resp, page){ /* */ return resp; }
				},
				escapeMarkup: function(str){ /* */ return str; }
			}).on('change', function(e){
				AppGini.current_slot__RAND__.value = e.added.id;
				AppGini.current_slot__RAND__.text = e.added.text;
				$j('[name="slot"]').val(e.added.id);
				if(e.added.id == '<?php echo empty_lookup_value; ?>'){ $j('.btn[id=slots_view_parent]').hide(); }else{ $j('.btn[id=slots_view_parent]').show(); }


				if(typeof(slot_update_autofills__RAND__) == 'function') slot_update_autofills__RAND__();
			});

			if(!$j("#slot-container__RAND__").length){
				$j.ajax({
					url: 'ajax_combo.php',
					dataType: 'json',
					data: { id: AppGini.current_slot__RAND__.value, t: 'bookings', f: 'slot' },
		...
		<?php }else{ ?>
			...
			$j.ajax({
				...
				data: { id: AppGini.current_slot__RAND__.value, t: 'bookings', f: 'slot' },
				success: function(resp){
					$j('[id=slot-container__RAND__], [id=slot-container-readonly__RAND__]').html('<span id="slot-match-text">' + resp.results[0].text + '</span>');
					if(resp.results[0].id == '<?php echo empty_lookup_value; ?>'){ $j('.btn[id=slots_view_parent]').hide(); }else{ $j('.btn[id=slots_view_parent]').show(); }
	...
	if(($selected_id && !$AllowUpdate && !$AllowInsert) || (!$selected_id && !$AllowInsert)){
		...
		$jsReadOnly .= "\tjQuery('#truck').prop('disabled', true).css({ color: '#555', backgroundColor: '#fff' });\n";
		$jsReadOnly .= "\tjQuery('#truck_caption').prop('disabled', true).css({ color: '#555', backgroundColor: 'white' });\n";
		$jsReadOnly .= "\tjQuery('#slot').prop('disabled', true).css({ color: '#555', backgroundColor: '#fff' });\n";
		$jsReadOnly .= "\tjQuery('#slot_caption').prop('disabled', true).css({ color: '#555', backgroundColor: 'white' });\n";
	...
	$templateCode = str_replace('<%%COMBO(truck)%%>', $combo_truck->HTML, $templateCode);
	$templateCode = str_replace('<%%COMBOTEXT(truck)%%>', $combo_truck->MatchText, $templateCode);
	$templateCode = str_replace('<%%URLCOMBOTEXT(truck)%%>', urlencode($combo_truck->MatchText), $templateCode);
	$templateCode = str_replace('<%%COMBO(slot)%%>', $combo_slot->HTML, $templateCode);
	$templateCode = str_replace('<%%COMBOTEXT(slot)%%>', $combo_slot->MatchText, $templateCode);
	$templateCode = str_replace('<%%URLCOMBOTEXT(slot)%%>', urlencode($combo_slot->MatchText), $templateCode);
	...
	$lookup_fields = array(  'id_number' => array('customers', 'Id number'), 'truck' => array('availability', 'truck'), 'slot' => array('slots', 'slot'));
	...
	$templateCode = str_replace('<%%UPLOADFILE(truck)%%>', '', $templateCode);
	$templateCode = str_replace('<%%UPLOADFILE(slot)%%>', '', $templateCode);
	...
	if($selected_id){
		...
		if( $dvprint) $templateCode = str_replace('<%%VALUE(truck)%%>', safe_html($urow['truck']), $templateCode);
		if(!$dvprint) $templateCode = str_replace('<%%VALUE(truck)%%>', html_attr($row['truck']), $templateCode);
		$templateCode = str_replace('<%%URLVALUE(truck)%%>', urlencode($urow['truck']), $templateCode);
		if( $dvprint) $templateCode = str_replace('<%%VALUE(slot)%%>', safe_html($urow['slot']), $templateCode);
		if(!$dvprint) $templateCode = str_replace('<%%VALUE(slot)%%>', html_attr($row['slot']), $templateCode);
		$templateCode = str_replace('<%%URLVALUE(slot)%%>', urlencode($urow['slot']), $templateCode);
		...
		$templateCode = str_replace('<%%VALUE(truck)%%>', '', $templateCode);
		$templateCode = str_replace('<%%URLVALUE(truck)%%>', urlencode(''), $templateCode);
		$templateCode = str_replace('<%%VALUE(slot)%%>', '', $templateCode);
		$templateCode = str_replace('<%%URLVALUE(slot)%%>', urlencode(''), $templateCode);
	...
	$templateCode .= "\ttruck_update_autofills$rnd1 = function(){\n";
	$templateCode .= "\t\t\$j.ajax({\n";
	if($dvprint){
		$templateCode .= "\t\t\turl: 'bookings_autofill.php?rnd1=$rnd1&mfk=truck&id=' + encodeURIComponent('".addslashes($row['truck'])."'),\n";
		$templateCode .= "\t\t\tcontentType: 'application/x-www-form-urlencoded; charset=" . datalist_db_encoding . "', type: 'GET'\n";
	}else{
		$templateCode .= "\t\t\turl: 'bookings_autofill.php?rnd1=$rnd1&mfk=truck&id=' + encodeURIComponent(AppGini.current_truck{$rnd1}.value),\n";
		$templateCode .= "\t\t\tcontentType: 'application/x-www-form-urlencoded; charset=" . datalist_db_encoding . "', type: 'GET', beforeSend: function(){ /* */ \$j('#truck$rnd1').prop('disabled', true); \$j('#truckLoading').html('<img src=loading.gif align=top>'); }, complete: function(){".(($arrPerm[1] || (($arrPerm[3] == 1 && $ownerMemberID == getLoggedMemberID()) || ($arrPerm[3] == 2 && $ownerGroupID == getLoggedGroupID()) || $arrPerm[3] == 3)) ? "\$j('#truck$rnd1').prop('disabled', false); " : "\$j('#truck$rnd1').prop('disabled', true); ")."\$j('#truckLoading').html('');}\n";
	}
	$templateCode.="\t\t});\n";
	$templateCode.="\t};\n";
	if(!$dvprint) $templateCode.="\tif(\$j('#truck_caption').length) \$j('#truck_caption').click(function(){ /* */ truck_update_autofills$rnd1(); });\n";
